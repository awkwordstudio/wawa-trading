...
<div id="pageContent">			
			<!-- parallax-img -->
			<section class="content--parallax content--parallax-sm offset-top-0" data-image="/assets/images/custom/parallax-img-05.jpg">
	...
	Ut enim ad minim veniam, quis nostrud exercitation ullamco.</em>
		...
		non proident, sunt in culpa qui officia deserunt mollit anim id est laborum
							...
							<div class="brand-lg-list">
								<div class="row-item">
									<a href="#"><img src="/assets/images/custom/brand-lg-01.png" class="img-responsive" alt=""></a>
									<a href="#"><img src="/assets/images/custom/brand-lg-02.png" class="img-responsive" alt=""></a>
									<a href="#"><img src="/assets/images/custom/brand-lg-03.png" class="img-responsive" alt=""></a>
									<a href="#"><img src="/assets/images/custom/brand-lg-04.png" class="img-responsive" alt=""></a>
									<a href="#"><img src="/assets/images/custom/brand-lg-05.png" class="img-responsive" alt=""></a>
								</div>
								<div class="row-item">
									<a href="#"><img src="/assets/images/custom/brand-lg-06.png" class="img-responsive" alt=""></a>
									<a href="#"><img src="/assets/images/custom/brand-lg-07.png" class="img-responsive" alt=""></a>
									<a href="#"><img src="/assets/images/custom/brand-lg-08.png" class="img-responsive" alt=""></a>
									<a href="#"><img src="/assets/images/custom/brand-lg-09.png" class="img-responsive" alt=""></a>
									<a href="#"><img src="/assets/images/custom/brand-lg-10.png" class="img-responsive" alt=""></a>
								</div>							
							</div>
						</div>
					</div>
			...
			<!-- / -->
			<!-- parallax-img -->
			<section class="content--parallax content--parallax-sm offset-top-0" data-image="/assets/images/custom/parallax-img-06.jpg">
				<div class="content">
					<div class="container">
						<div class="parallax-text">
							<div class="block-table">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="/assets/images/custom/team-img-01.jpg" class="img-responsive-block" alt=""></a>							
							<div class="divider divider--md1"></div>
							<p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="/assets/images/custom/team-img-02.jpg" class="img-responsive-block" alt=""></a>
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="/assets/images/custom/team-img-03.jpg" class="img-responsive-block" alt=""></a>
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="/assets/images/custom/team-img-04.jpg" class="img-responsive-block" alt=""></a>
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
